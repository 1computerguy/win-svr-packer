...
Configuration MEMBER_SUBCA
{
    ...
    Node $AllNodes.NodeName {
        ...
        ADCSCertificationAuthority ConfigCA
        {
            ...
            KeyLength                 = 2048
            DependsOn                 = @('[Script]InstallRootCACert','[xDisk]DiskE','[xDisk]DiskF')
        }
...
MEMBER_SUBCA -ConfigurationData .\MemberSubCA.psd1

Set-DscLocalConfigurationManager -Path .\MEMBER_SUBCA -Verbose -Force

Start-DscConfiguration -Wait -Path .\MEMBER_SUBCA -Verbose -Force